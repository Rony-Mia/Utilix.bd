    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-10">
      ...
      <section className="space-y-3 border-b border-[#d8cfb8] pb-6">
        <div className="inline-flex items-center gap-2 bg-[#fffdf7] border border-[#d8cfb8] px-3 py-1 text-xs text-[#083f2a] font-medium">
          <Shield className="w-3.5 h-3.5 text-[#0c5c3d]" />
        ...
        <div className="flex flex-wrap items-center gap-3 text-xs text-[#6b6255]">
          ...
          <span>•</span>
          <span className="text-[#0c5c3d] font-semibold">কার্যকর: সার্বজনীন সংস্করণ</span>
        </div>
      </section>

      {/* Summary Box */}
      <section className="bg-[#fffdf7] border border-[#d8cfb8] p-6 space-y-4">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-[#4a4237] leading-relaxed mt-1">
      ...
      {/* Detailed Sections */}
      <div className="space-y-8 text-sm text-[#14231c] leading-relaxed">
        {/* Section 1 */}
        <section className="bg-[#fffdf7] border border-[#d8cfb8] p-6 sm:p-8 space-y-3">
          <h2 className="text-lg font-bold text-[#083f2a] font-serif flex items-center space-x-2">
            <Cpu className="w-4 h-4 text-[#0c5c3d]" />
          ...
          <ul className="list-disc list-inside space-y-1 text-xs sm:text-sm text-[#4a4237] pl-2">
        ...
        <section className="bg-[#fffdf7] border border-[#d8cfb8] p-6 sm:p-8 space-y-3">
          <h2 className="text-lg font-bold text-[#083f2a] font-serif flex items-center space-x-2">
            <EyeOff className="w-4 h-4 text-[#0c5c3d]" />
        ...
        <section className="bg-[#fffdf7] border border-[#d8cfb8] p-6 sm:p-8 space-y-3">
          <h2 className="text-lg font-bold text-[#083f2a] font-serif flex items-center space-x-2">
            <HardDrive className="w-4 h-4 text-[#0c5c3d]" />
        ...
        <section className="bg-[#fffdf7] border border-[#d8cfb8] p-6 sm:p-8 space-y-3">
          ...
          <div className="pt-2">
            <p className="text-xs text-[#6b6255]">
              ...
              <a href="mailto:contact@utilix.bd" className="font-mono text-[#0c5c3d] underline">
                contact@utilix.bd
              </a>
            </p>
          </div>
      ...
      {/* Footer Navigation */}
      <div className="pt-6 border-t border-[#d8cfb8] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#6b6255]">
        <Link to="/" className="text-[#0c5c3d] hover:underline flex items-center">
          ← হোমপেজে ফিরে যান
        </Link>
        <Link to="/about" className="text-[#0c5c3d] hover:underline flex items-center">
