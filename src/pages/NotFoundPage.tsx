...
const POPULAR_TOOLS: ReadonlyArray<{ to: string; label: string }> = [
  ...
  { to: '/photo-resizer', label: 'সরকারি ছবি ও স্বাক্ষর রিসাইজার (Teletalk/BPSC)' },
  { to: '/age-calculator', label: 'চাকরির বয়স ক্যালকুলেটর' },
  { to: '/gpa-calculator', label: 'GPA / CGPA ক্যালকুলেটর' },
  { to: '/amount-in-words', label: 'টাকা কথায় রূপান্তর' },
  { to: '/cv-builder', label: 'ফ্রি সিভি মেকার' },
