    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-10">
      ...
      <section className="space-y-3 border-b border-[#d8cfb8] pb-6">
        <div className="inline-flex items-center gap-2 bg-[#fffdf7] border border-[#d8cfb8] px-3 py-1 text-xs text-[#083f2a] font-medium">
          <Globe2 className="w-3.5 h-3.5 text-[#0c5c3d]" />
      ...
      <section className="bg-[#fffdf7] border border-[#d8cfb8] p-6 sm:p-8 space-y-6">
        <div className="space-y-4 text-sm sm:text-base text-[#14231c] leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-[#d8cfb8]">
          <div className="border border-[#d8cfb8] bg-[#f4efe4]/60 p-4 space-y-1.5">
            <div className="flex items-center space-x-2 text-[#083f2a] font-bold text-sm">
              <Users className="w-4 h-4 text-[#0c5c3d]" />
          ...
          <div className="border border-[#d8cfb8] bg-[#f4efe4]/60 p-4 space-y-1.5">
            <div className="flex items-center space-x-2 text-[#083f2a] font-bold text-sm">
              <GraduationCap className="w-4 h-4 text-[#0c5c3d]" />
          ...
          <div className="border border-[#d8cfb8] bg-[#f4efe4]/60 p-4 space-y-1.5">
            <div className="flex items-center space-x-2 text-[#083f2a] font-bold text-sm">
              <Heart className="w-4 h-4 text-[#0c5c3d]" />
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between border-b border-[#d8cfb8] pb-2">
          ...
          <span className="text-xs text-[#6b6255] font-mono">{TOOLS.length}টি টুল উপলব্ধ</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {TOOLS.map((tool) => (
            <div
              key={tool.id}
              className="bg-[#fffdf7] border border-[#d8cfb8] p-5 flex flex-col justify-between hover:border-[#0c5c3d]/60 transition-colors"
            >
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-medium bg-[#0c5c3d] text-[#fffdf7] px-2 py-0.5">
                    সক্রিয়
                  </span>
                </div>
              ...
              <div className="pt-4 mt-4 border-t border-[#d8cfb8] flex items-center justify-between">
                <span className="text-xs text-[#14231c] truncate max-w-[200px]">
                  {tool.feature}
                </span>
                {tool.link && (
                  <Link
      ...
      <section className="bg-[#fffdf7] border border-[#d8cfb8] p-6 sm:p-8 space-y-6">
        ...
        <div className="text-xs sm:text-sm text-[#14231c] leading-relaxed space-y-4">
          <p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
            <div className="flex items-start space-x-2 border border-[#d8cfb8] bg-[#f4efe4]/40 p-3">
              <CheckCircle2 className="w-4 h-4 text-[#0c5c3d] shrink-0 mt-0.5" />
              <span className="text-xs text-[#14231c]">
        ...
        <div className="pt-4 border-t border-[#d8cfb8] flex flex-wrap items-center justify-between gap-4">
          <p className="text-xs text-[#6b6255]">
            আমাদের ডেটা সুরক্ষা নীতিমালা সম্পর্কে বিস্তারিত জানতে আমাদের গোপনীয়তা নীতি পড়ুন।
          </p>
          <Link
            to="/privacy-policy"
            className="text-xs font-semibold text-[#0c5c3d] hover:text-[#083f2a] underline flex items-center"
          >
      ...
      {/* Call to Action */}
      <section className="bg-[#083f2a] text-[#fffdf7] p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="space-y-1">
          <h3 className="text-lg sm:text-xl font-bold font-serif">
            কোনো প্রশ্ন বা নতুন টুল প্রস্তাবনা আছে?
          </h3>
          <p className="text-xs sm:text-sm text-[#d8cfb8]">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <Link
            to="/contact"
            className="px-4 py-2 bg-[#fffdf7] text-[#083f2a] text-xs sm:text-sm font-semibold hover:bg-[#f4efe4] transition-colors"
          >
            আমাদের সাথে যোগাযোগ করুন
          </Link>
          <Link
            to="/"
            className="px-4 py-2 border border-[#fffdf7]/40 text-[#fffdf7] text-xs sm:text-sm font-medium hover:bg-[#fffdf7]/10 transition-colors"
          >
            হোমপেজে ফিরুন
          </Link>
        </div>
