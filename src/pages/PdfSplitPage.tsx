...
export const PdfSplitPage: React.FC = () => {
  ...
  const softwareAppSchema = {
    ...
    name: 'Utilix.bd পিডিএফ স্প্লিটার (PDF Splitter)',
    operatingSystem: 'All',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'না, একদমই কমে না। Utilix.bd-এর পিডিএফ স্প্লিটার কোনো ইমেজ কম্প্রেশন বা রি-এনকোডিং ছাড়াই সরাসরি ভেক্টর পেজ স্ট্রাকচার আলাদা করে। ফলে মূল ডকুমেন্টের প্রতিটি ফন্ট, ভেক্টর শেপ ও ছবির কোয়ালিটি ১০০% অক্ষুণ্ণ থাকে।',
        },
      },
      {
        '@type': 'Question',
  ...
  return (
    <PdfToolLayout
      title="পিডিএফ স্প্লিটার — PDF Split Online Free | Utilix.bd"
      ...
      canonicalUrl="https://utilix.bd/pdf-split"
      ogTitle="পিডিএফ স্প্লিটার — PDF Split Online Free | Utilix.bd"
      ...
      refCode="DOC-PDF-02"
      badgeText="ডকুমেন্ট ইউটিলিটি • প্রফেশনাল পিডিএফ স্প্লিটার v1.0"
      ...
      deepDiveTitle="কেন Utilix.bd-এর পিডিএফ স্প্লিটার অনন্য ও নির্ভরযোগ্য?"
      deepDiveContent={
        <>
          <p>
