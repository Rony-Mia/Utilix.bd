...
export const PdfDeletePagesPage: React.FC = () => {
  ...
  const softwareAppSchema = {
    ...
    name: 'Utilix.bd পিডিএফ পেজ ডিলিট (PDF Delete Pages)',
    operatingSystem: 'All',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'একদমই না! Utilix.bd কোনো ইমেজ কম্প্রেশন বা টেক্সট পরিবর্তন করে না। শুধুমাত্র আপনি যে পেজগুলো বাদ দিয়েছেন সেগুলো বাদ দিয়ে বাকি পেজগুলোকে অবিকল মূল রেজোলিউশন ও ফন্টসহ সংরক্ষণ করে নতুন পিডিএফ তৈরি করে।',
        },
      },
      {
        '@type': 'Question',
  ...
  return (
    <PdfToolLayout
      title="পিডিএফ পেজ ডিলিট — PDF Delete Pages Online Free | Utilix.bd"
      ...
      canonicalUrl="https://utilix.bd/pdf-delete-pages"
      ogTitle="পিডিএফ পেজ ডিলিট — PDF Delete Pages Online Free | Utilix.bd"
      ...
      refCode="DOC-PDF-03"
      badgeText="ডকুমেন্ট ইউটিলিটি • প্রফেশনাল পেজ রিমুভার v1.0"
      ...
      deepDiveContent={
        <>
          ...
          <p>
            Utilix.bd-এর <strong>পিডিএফ পেজ ডিলিট</strong> টুলটি অত্যন্ত হালকা ও ব্যবহারবান্ধব। ফাইলটি ব্রাউজারে আপলোড করা মাত্রই প্রতিটি পৃষ্ঠার স্পষ্ট নম্বর প্রদর্শিত হয়। আপনি মাউসের এক ক্লিকে বা মোবাইল টাচে যে পৃষ্ঠাগুলো বাদ দিতে চান তা সিলেক্ট করে দিন। অবশিষ্ট পেজগুলো দিয়ে কোনো বিলম্ব ছাড়াই তাত্ক্ষণিক একটি নতুন ক্লিন পিডিএফ ফাইল তৈরি হয়ে যায়।
          </p>
        </>
      }
