      ...
      <div className="bg-[#fffdf7] border border-[#d8cfb8] p-5 sm:p-6 space-y-5">
        ...
        <div className="space-y-4 text-xs sm:text-sm text-[#14231c] leading-relaxed">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[#4a4237]">
              প্রথমে আপনার ছবি আপলোড করে ব্যাকগ্রাউন্ড রিমুভ করুন। এরপর কালার প্যালেট থেকে "সাদা" সিলেক্ট করে ডাউনলোড করুন। এরপর আমাদের "সরকারি ও পাসপোর্ট ছবি রিসাইজার" টুলে গিয়ে ছবিটি ৩০০০×৩০০০ পিক্সেল এবং ১০০KB-র নিচে রিসাইজ করে নিন।
            </p>
          </div>
        </div>
      </div>
