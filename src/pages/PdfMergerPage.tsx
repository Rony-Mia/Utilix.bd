...
export const PdfMergerPage: React.FC = () => {
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'না, বিন্দুমাত্র মান কমে না। Utilix.bd-এর পিডিএফ মার্জার কোনো ক্ষতিকর কম্প্রেশন প্রয়োগ করে না। আপনার প্রতিটি মূল ডকুমেন্টের ভেক্টর টেক্সট, হাই-রেজোলিউশন ছবি, ফন্ট এবং পেজ ডাইমেনশন অবিকল অক্ষুণ্ণ রেখে শুধুমাত্র পেজগুলোকে একত্রিত করে।',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Utilix.bd-এর কোনো কৃত্রিম ফাইল সংখ্যা বা পেজ সীমা নেই। সম্পূর্ণ প্রসেসটি আপনার ব্রাউজারের মেমোরিতে (RAM) সম্পন্ন হয়। ফলে সাধারণ কম্পিউটার বা স্মার্টফোনে অনায়াসে ২০-৫০টি ফাইল বা শত শত পেজ একসাথে মার্জ করা যায়।',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'হ্যাঁ, Utilix.bd-এর প্রতিটি ইউটিলিটি টুলের মতো এই পিডিএফ মার্জার টুলটিও আজীবন শতভাগ বিনামূল্যে উন্মুক্ত। কোনো প্রকার হিডেন চার্জ, ওয়াটারমার্ক, দৈনিক ট্রায়াল লিমিট বা ক্রেডিট কার্ডের প্রয়োজন নেই।',
        },
      },
    ],
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
      <Helmet>
        <title>পিডিএফ মার্জার — আনলিমিটেড PDF Merge Online Free | Utilix.bd</title>
        <meta
          name="description"
        ...
        />
        <link rel="canonical" href="https://utilix.bd/pdf-merger" />
        <meta
          property="og:title"
          content="পিডিএফ মার্জার — আনলিমিটেড PDF Merge Online Free | Utilix.bd"
        />
        <meta
          property="og:description"
          content="একাধিক PDF ফাইল একত্র করুন সম্পূর্ণ বিনামূল্যে। কোনো ফাইল বা পেজ সীমা নেই, ১০০% ক্লায়েন্ট-সাইড ব্রাউজারেই নিরাপদ ও দ্রুত মার্জ — কোনো সার্ভার আপলোড নেই।"
        />
        <meta property="og:url" content="https://utilix.bd/pdf-merger" />
