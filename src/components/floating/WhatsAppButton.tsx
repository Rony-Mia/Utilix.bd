...
import { WHATSAPP_NUMBER } from '../../data/site.ts';
...
/**
 * Floating click-to-chat button. It is a plain link to wa.me — no script, no tracking, no data leaves the
 * site until the visitor chooses to open WhatsApp. On a tool page the first message names that tool.
 */
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      ...
      aria-label="WhatsApp-এ আমাদের সাথে চ্যাট করুন (নতুন ট্যাবে খুলবে)"
      className="wa-fab"
    >
